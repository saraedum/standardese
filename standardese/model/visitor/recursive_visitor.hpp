...
#ifndef STANDARDESE_MODEL_VISITOR_RECURSIVE_VISITOR_HPP_INCLUDED
#define STANDARDESE_MODEL_VISITOR_RECURSIVE_VISITOR_HPP_INCLUDED
...
class recursive_visitor : public visitor<is_const>
{
  public:
    ...
    virtual void visit(typename visitor<is_const>::document&) override;
    virtual void visit(typename visitor<is_const>::image&) override;
};
