...
#include "../../../include/standardese/output/markup/entity_index.hpp"
...
#include "../../../include/standardese/output/markup/module_documentation.hpp"
...
<dd>&mdash; with brief</dd>
  ...
  - b.hpp &mdash; with brief
    ...
    REQUIRE(markdown_generator::render(*index) == md);
}
