...
// TODO(0.6.0-alpha): bring these back
...
#include "../../include/standardese/parser/commands/special_command.hpp"
...
-----
    ...
    entity_documentation a(block_id("a"), type_safe::ref(entity.get()),
                                    documentation_header(heading("Entity A"), "module_a"),
                                    code_block(block_id(), "cpp", "void a();"));
    entity_documentation b(block_id("b"), type_safe::ref(entity.get()),
                                    documentation_header(heading("Entity B"),
                                                         "module_b"),
