...
struct regex {
  ...
  static std::regex set_href_external_legacy_transformer_pattern;
  static std::regex set_href_external_legacy_transformer_replace;
  static std::regex set_id_transformer_escape;
  static std::regex set_id_transformer_strip;
  static std::regex set_target_external_transformer_schema_pattern;
  static std::regex set_target_internal_transformer_entity_pattern;
  static std::regex set_target_internal_transformer_uri_pattern;
