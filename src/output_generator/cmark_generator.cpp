...
#include "../../../standardese/output_generator/cmark_generator.hpp"
...
void cmark_generator::visit(cpp_entity_documentation& documentation) {
  stream_generator::visit(documentation);
}

void cmark_generator::visit(group_documentation& documentation) {
  stream_generator::visit(documentation);
}
