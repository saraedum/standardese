...
create_entity_heading_transformer::create_entity_heading_transformer(model::unordered_entities* entities, const parser::cpp_context& cpp_context, struct create_entity_heading_transformer_options options) : inner_transformer(entities), options(options), cpp_context(cpp_context) {}
