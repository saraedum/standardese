...
exclude_uncommented_transformer::exclude_uncommented_transformer(model::unordered_entities& documents, struct options options) : transformer(documents), options(std::move(options)) {}
