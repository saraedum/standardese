...
exclude_uncommented_transformer::exclude_uncommented_transformer(model::entity_set* documents, exclude_uncommented_transformer_options options) : inner_transformer(documents), options(std::move(options)) {}
