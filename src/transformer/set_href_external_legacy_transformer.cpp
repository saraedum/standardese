...
set_href_external_legacy_transformer::set_href_external_legacy_transformer(model::entity_set* documents, set_href_external_legacy_transformer_options options): inner_transformer(documents), options(options) {}
