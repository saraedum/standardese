...
create_link_text_transformer::create_link_text_transformer(model::entity_set* documents, const parser::cpp_context& context, link_text_transformer_options options) : inner_transformer(documents), options(std::move(options)), context(context) {
}
