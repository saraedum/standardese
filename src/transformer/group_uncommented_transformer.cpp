...
group_uncommented_transformer::group_uncommented_transformer(model::unordered_entities& documents, group_uncommented_options options) : transformer(documents), options(std::move(options)) {}
