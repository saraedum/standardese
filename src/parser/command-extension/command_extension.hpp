...
namespace standardese::parser::command_extension
{
    ...
    class command_extension : cmark_extension::cmark_extension
    {
      public:
        ...
        static command_extension& create(cmark_parser* parser, struct comment_parser::comment_parser_options::command_extension_options={});
      ...
      private:
        command_extension(struct comment_parser::comment_parser_options::command_extension_options, cmark_syntax_extension*);
        ...
        struct comment_parser::comment_parser_options::command_extension_options options;
