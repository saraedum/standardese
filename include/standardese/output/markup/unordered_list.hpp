...
#ifndef STANDARDESE_OUTPUT_MARKUP_UNORDERED_LIST_HPP_INCLUDED
#define STANDARDESE_OUTPUT_MARKUP_UNORDERED_LIST_HPP_INCLUDED
...
namespace standardese::output::markup
{
    ...
    public:
        ...
        public:
            ...
            builder(block_id id)
            : container_builder(std::unique_ptr<unordered_list>(new unordered_list(std::move(id))))
            {}
